...
# ============================================================================
# TEST 4: VALIDATORORG - APPROVE CAMPAIGNS
# ============================================================================
# This script tests campaign approval by ValidatorOrg
# Run test3_validator_compliance.sh first
# ============================================================================
...
# Results
RESULTS_FILE="test4_validator_approve_results_$(date +%Y%m%d_%H%M%S).txt"
...
print_header "TEST 4: VALIDATORORG - APPROVE CAMPAIGNS"
...
print_info "Found $NUM_CAMPAIGNS campaigns to approve"
...
echo ""
read -p "Press Enter to start approving campaigns..."

# ============================================================================
# APPROVE CAMPAIGNS
# ============================================================================

print_header "Approving $NUM_CAMPAIGNS Campaigns"
...
while IFS= read -r CAMPAIGN_ID; do
    ...
    RESULT=$(peer chaincode invoke \
        ...
        -c "{\"function\":\"ApproveCampaign\",\"Args\":[\"$CAMPAIGN_ID\"]}" \
        2>&1)
...
echo -e "\n"
print_header "TEST 4 RESULTS"

print_metric "Campaigns Approved" "$SUCCESS_COUNT/$NUM_CAMPAIGNS"
...
if [ $SUCCESS_COUNT -eq $NUM_CAMPAIGNS ]; then
    print_success "ALL CAMPAIGNS APPROVED SUCCESSFULLY! 🎉"
    print_info "Full workflow complete! Check test_summary.sh for overall results"
else
    echo -e "${YELLOW}Some approvals failed. Check errors above.${NC}"
fi

# Save results
{
    echo "=================================="
    echo "TEST 4: VALIDATORORG - APPROVE CAMPAIGNS"
    echo "Date: $(date)"
    echo "=================================="
    echo ""
    echo "Campaigns Approved: $SUCCESS_COUNT/$NUM_CAMPAIGNS"
