...
# ============================================================================
# TEST 3: VALIDATORORG - SET COMPLIANCE SCORES
# ============================================================================
# This script tests setting compliance scores by ValidatorOrg
# Run test2_validator_risk.sh first
# ============================================================================
...
# Results
RESULTS_FILE="test3_validator_compliance_results_$(date +%Y%m%d_%H%M%S).txt"
...
print_header "TEST 3: VALIDATORORG - SET COMPLIANCE SCORES"
...
echo ""
read -p "Press Enter to start setting compliance scores..."

# ============================================================================
# SET COMPLIANCE SCORES
# ============================================================================

print_header "Setting Compliance Scores for $NUM_CAMPAIGNS Campaigns"
...
while IFS= read -r CAMPAIGN_ID; do
    ...
    # Random compliance score between 70-95
    COMPLIANCE_SCORE=$((70 + RANDOM % 26))
    ...
    RESULT=$(peer chaincode invoke \
        ...
        -c "{\"function\":\"SetComplianceScore\",\"Args\":[\"$CAMPAIGN_ID\",\"$COMPLIANCE_SCORE\"]}" \
        2>&1)
...
echo -e "\n"
print_header "TEST 3 RESULTS"

print_metric "Compliance Scores Set" "$SUCCESS_COUNT/$NUM_CAMPAIGNS"
...
if [ $SUCCESS_COUNT -eq $NUM_CAMPAIGNS ]; then
    print_success "ALL COMPLIANCE SCORES SET SUCCESSFULLY! 🎉"
    print_info "Run test4_validator_approve.sh next to approve campaigns"
else
...
{
    echo "=================================="
    echo "TEST 3: VALIDATORORG - SET COMPLIANCE SCORES"
    echo "Date: $(date)"
    echo "=================================="
    echo ""
    echo "Compliance Scores Set: $SUCCESS_COUNT/$NUM_CAMPAIGNS"
